...
// // function constant(dimensions, num) {
// //     var array = [];

// //     for (var i = 0; i < dimensions[0]; ++i) {
// //         array.push(dimensions.length == 1 ? num : constant(dimensions.slice(1), num));
// //     }

// //     return array;
// // }

// // console.log(tf.tensor(constant([2,2], 1)).shape)

// // console.log(tf.initializers.randomNormal({'mean':0, 'stddev':1}).apply([5,5], "float32"))

// // var wpe = tf.variable(tf.initializers.randomNormal({mean:0, stddev:0.01}).apply([0, 768]));

// // console.log(wpe.shape)

// // var wpe = tf.variable(tf.initializers.randomNormal({mean:0, stddev:0.01}).apply([3, 5]));
// // var wte = tf.variable(tf.initializers.randomNormal({mean:0, stddev:0.02}).apply([1, 3, 5], 'float32'));

// // var wpe2 = tf.variable(tf.initializers.randomNormal({mean:0, stddev:0.01}).apply([3, 5]));

// // console.log(wpe + wpe2)

// var result = tf.layers.embedding();
